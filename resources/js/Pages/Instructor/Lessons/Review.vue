            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                >
                    <div class="p-6">
                        ...
                        <!-- AI Provider Info -->
                        <div
                            v-if="aiMetadata?.provider_used"
                            class="mb-4 flex items-center gap-3 p-3 bg-gradient-to-r from-cyan-50 to-blue-50 dark:from-cyan-900/20 dark:to-blue-900/20 rounded-lg border border-cyan-200 dark:border-cyan-800"
                        >
                            <div class="flex items-center gap-2">
                                ...
                                <span
                                    class="text-sm font-medium text-cyan-700 dark:text-cyan-300"
                                >
                                    Generated by:
                                </span>
                                <span
